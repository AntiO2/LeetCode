 ...
 * @author AntiO2
 * @date 2024/10/05
 * @see https://leetcode.cn/problems/count-of-substrings-containing-every-vowel-and-k-consonants-i
 */
...
TEST_F(LeetCodeTest, 3305_test1) {
    Solution sol;
    // sol.test();
}

TEST_F(LeetCodeTest, 3305_test2) {
    Solution sol;
}
